...
- **Documented production incidents** — nginx upstream resolution, Docker build disk exhaustion, and backup failures were each root-caused and written up as incident reports with lessons learned
