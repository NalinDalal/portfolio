      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card>
          <CardContent className="p-6">
            <h2 className="font-display text-2xl font-bold text-text-primary mb-4">About</h2>
        ...
        <Card>
          <CardContent className="p-6">
            <h2 className="font-display text-2xl font-bold text-text-primary mb-4">Skills</h2>
