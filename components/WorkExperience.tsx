...
function WorkExperience() {
  return (
    <section id="work-experience" className="py-8">
      ...
      <h2 className="font-display font-bold text-[var(--text-display)] tracking-[-0.025em] mb-2 text-text-primary">
        Work Experience
      </h2>
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => (
            <div key={index} className="relative pl-12">
              ...
              <div className="bg-surface rounded-xl p-5 border border-border transition-all duration-200 hover:border-accent/30 hover:scale-[1.02]">
